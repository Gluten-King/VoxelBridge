...
public final class ExportRuntimeConfig {
    ...
    public static AtlasMode getAtlasMode() { return atlasMode; }
    public static void setAtlasMode(AtlasMode mode) { if (mode != null) atlasMode = mode; }

    public static AtlasSize getAtlasSize() { return atlasSize; }
    public static void setAtlasSize(AtlasSize size) { if (size != null) atlasSize = size; }

    public static int getAtlasPadding() { return atlasPadding; }
    public static boolean setAtlasPadding(int padding) {
        if (padding == 0 || padding == 4 || padding == 8 || padding == 12 || padding == 16) {
            atlasPadding = padding; return true;
        }
        return false;
    }

    public static CoordinateMode getCoordinateMode() { return coordinateMode; }
    public static void setCoordinateMode(CoordinateMode mode) { if (mode != null) coordinateMode = mode; }

    public static int getExportThreadCount() { return exportThreadCount; }
    public static void setExportThreadCount(int count) {
        if (count < 1) exportThreadCount = 1;
        else if (count > 32) exportThreadCount = 32;
        else exportThreadCount = count;
    }

    public static boolean isVanillaRandomTransformEnabled() { return vanillaRandomTransformEnabled; }
    public static void setVanillaRandomTransformEnabled(boolean enabled) { vanillaRandomTransformEnabled = enabled; }

    public static ColorMode getColorMode() { return colorMode; }
    public static void setColorMode(ColorMode mode) { if (mode != null) colorMode = mode; }

    public static boolean isAnimationEnabled() { return animationEnabled; }
    public static void setAnimationEnabled(boolean enabled) { animationEnabled = enabled; }

    public static boolean isFillCaveEnabled() { return fillCaveEnabled; }
    public static void setFillCaveEnabled(boolean enabled) { fillCaveEnabled = enabled; }

    public static boolean isPbrDecodeEnabled() { return pbrDecodeEnabled; }
    public static void setPbrDecodeEnabled(boolean enabled) { pbrDecodeEnabled = enabled; }
}

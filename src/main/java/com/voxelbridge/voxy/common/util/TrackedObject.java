...
import com.voxelbridge.voxy.VoxyConfig;

import java.lang.ref.Cleaner;

import static com.voxelbridge.voxy.common.util.GlobalCleaner.CLEANER;

public abstract class TrackedObject {
    public static final boolean TRACK_OBJECT_ALLOCATIONS = VoxyConfig.isVerificationFlagOn("ensureTrackedObjectsAreFreed", true);
    public static final boolean TRACK_OBJECT_ALLOCATION_STACKS = VoxyConfig.isVerificationFlagOn("trackObjectAllocationStacks", false);

package com.voxelbridge.voxy.common.world;
...
public final class WorldSection {
    ...
    public static final boolean VERIFY_WORLD_SECTION_EXECUTION = VoxyConfig.isVerificationFlagOn("verifyWorldSectionExecution");

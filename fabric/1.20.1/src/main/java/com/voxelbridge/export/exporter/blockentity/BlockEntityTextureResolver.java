...
public final class BlockEntityTextureResolver implements TextureResolver<BlockEntity> {
    ...
    private static ResolvedTexture resolveFromBlockEntity(BlockEntity blockEntity, ResourceLocation current) {
        ...
        if (blockEntity instanceof EnderChestBlockEntity) {
            ResourceLocation tex = new ResourceLocation("minecraft", "entity/chest/ender");
        ...
        if (blockEntity instanceof BedBlockEntity bed) {
            ...
            ResourceLocation tex = new ResourceLocation("minecraft", "entity/bed/" + color.getName());
    ...
    private static ResolvedTexture resolveChestTexture(ChestBlockEntity chest) {
        ...
        if (block instanceof EnderChestBlock) {
            return resolveTextureInAtlas(Sheets.CHEST_SHEET, new ResourceLocation("minecraft", "entity/chest/ender"));
        }
        ...
        return resolveTextureInAtlas(Sheets.CHEST_SHEET, new ResourceLocation("minecraft", "entity/chest/" + base + suffix));
    }
    ...
    private static ResolvedTexture resolveSignTexture(Block block, boolean hanging) {
        ...
        ResourceLocation texture = new ResourceLocation(namespace, prefix + path);

...
/** Normalizes the exact-runtime baked-model API into borrowed pipeline quads. */
final class MinecraftBlockGeometrySource implements BlockGeometrySource {
    ...
    MinecraftBlockGeometrySource(Level level, WorldSource world, boolean vanillaRandomTransform) {
        this.level = level;
        this.world = world;

...
/** Minecraft 1.21.11 map-decoration atlas adapter. */
final class MapDecorationUvStrategy12111 {
    private static final String CACHE_KEY = "entity:map-decoration-atlas-size";

    private MapDecorationUvStrategy12111() {}
    ...
    static RenderCaptureUtil.UvStats normalize(ExportContext context,
        ...
        Identifier texture = RenderTypeTextureResolver.INSTANCE.resolve(renderType);
    ...
    private static int[] atlasSize(ExportContext context, Identifier atlasLocation) {

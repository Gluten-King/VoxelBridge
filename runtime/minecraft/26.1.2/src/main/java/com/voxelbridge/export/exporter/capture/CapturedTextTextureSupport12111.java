...
/** Minecraft 1.21.11 glyph fallback, diagnostics, and UV policy. */
public final class CapturedTextTextureSupport12111 {
    private CapturedTextTextureSupport12111() {}
    ...
    public static void writeBlockEntityUvs(ExportContext context,
                                           ...
                                           float[] target) {
        if (atlasUv) {
            float atlasU0 = texture != null ? texture.u0() : u0;
            float atlasU1 = texture != null ? texture.u1() : u1;
            float atlasV0 = texture != null ? texture.v0() : v0;
            float atlasV1 = texture != null ? texture.v1() : v1;
            RenderCaptureUtil.fillUvsAtlas(vertices, target, atlasU0, atlasU1, atlasV0, atlasV1);
            return;
        }
        RenderCaptureUtil.fillUvsClamp(vertices, target);
        if (hasPixelUvs(stats) && texture != null) {

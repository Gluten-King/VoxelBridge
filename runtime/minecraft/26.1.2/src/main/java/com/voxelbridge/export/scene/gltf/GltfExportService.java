...
public final class GltfExportService {
    ...
    public static Path exportRegion(Level level,
        ...
        ExportContext ctx = new ExportContext(mc, level, MinecraftTextureAccess.INSTANCE);
        try {
        ...
        com.voxelbridge.export.texture.ColorMapManager.initializeReservedSlots(
            ctx.state(), ctx.textureOptions().atlasSize());
        ...
        GltfSceneBuilder sceneBuilder = new GltfSceneBuilder(ctx.state(), gltfDir, reporter, ctx.textureOptions());
